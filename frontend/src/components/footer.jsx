...
const Footer = () => {
  return (
    <footer className="bg-black py-8 text-white  lg:px-32 font-trade-gothic border-t border-gray-600">
      <div className="container mx-auto px-4">
            ...
            <Link to='/'>
              <div className="flex space-x-4 items-center">
                <img
                  src="/shiva.png "
                  alt="logo"
                  className="w-[112px] h-[90px] md:h-[70px] md:w-auto invert "
                />
                <p className='lg:text-2xl text-white font-semibold font-serif' >
                  Shri Kaleshwar Trading Company <br />
                  <span className="">Kalegaon (Ghat) Tq. Kaij </span>
                </p>
              </div>
            </Link>
        ...
        <div className="mt-8 border-t border-gray-700 pt-4 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">© 2024 Prathmesh Gatade</p>
